...
class _DepartmentState extends State<Department> {
  ...
  Widget build(BuildContext context) {
    ...
    CollectionReference collectionReference = Firestore.instance.collection("departments");
    addProduct(){
      productToAdd={
        "name":nameController.text,
        "brand":idController.text,
        ...
        body: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              children: <Widget>[
                SizedBox(height: 10,),
                _buildTextField(nameController, 'department_name'),
                SizedBox(height: 10,),
                _buildTextField(idController, 'department_id'),
                SizedBox(height: 10,),
